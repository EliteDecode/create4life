        ...
        <div class="row">
            ...
            <div class="col-md-10 col-lg-10 col-xl-10">
                ...
                <?php 
                     ...
                     $sql = "SELECT * FROM proof WHERE Stats='pending' ORDER BY DatePaid ASC";
                     ...
                     if (mysqli_num_rows($result) < 1) {
                         ...
                         while($row = mysqli_fetch_assoc($result)){
                             ...
                             $output .= "<tr> 
                                         ...
                                         <td ><button class='btn btn-danger' onclick='confirm(this)'
                                          id='$id' style='font-size:12px; font-weight:bold;'>Confirm</button></td>
                                         </tr>";
                         }
                     }
